<template>
  <div class="page">
    ...
    <uploader ref="uploader" uploadButton="#filePicker" multiple @fileChange="fileChange" @progress="onProgress" @success="onSuccess"></uploader>
  </div>
</template>

<script>
import Uploader from './uploader'
import picturePatchUpload from '@/api'
