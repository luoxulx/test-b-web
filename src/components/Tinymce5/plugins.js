...
const plugins = [
  ...
  // 禁止使用 fullpage 插件!
  'tinydrive print preview searchreplace autolink directionality visualblocks code visualchars fullscreen image link media template codesample table charmap hr pagebreak nonbreaking anchor toc insertdatetime advlist lists wordcount imagetools textpattern help paste'
]
